...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="ReportUsersOrders">
    <html>
      <head>
      ...
      <body>
        <table>
          <tr>
            <td colspan ="10">
              <h2>
                ОТЧЕТ ПО ЗАКАЗАМ СОТРУДНИКОВ ЗА ПЕРИОД
              </h2>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan ="9">
              <xsl:value-of select="round(100*TotalSumm) div 100"/> руб.
            </td>
          </tr>

          <xsl:for-each select="Employee/ReportUserOrders">

            <tr>
              <td colspan="10"></td>
            </tr>
            <tr class="td-background-employee">
              <td>Сотрудник</td>
              <td colspan="5">
                <xsl:choose>
                  <xsl:when test="User/UserFullName != ''">
